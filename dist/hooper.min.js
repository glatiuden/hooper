...
(t = this),
  (i = function(t, i) {
    ...
    function l(t, i, e) {
      return (
        (i = r(i)) in t
          ? Object.defineProperty(t, i, { value: e, enumerable: !0, configurable: !0, writable: !0 })
          : (t[i] = e),
        t
      );
    }
    function h(i) {
      for (var t = 1; t < arguments.length; t++) {
        var e = null != arguments[t] ? Object(arguments[t]) : {},
          r = Object.keys(e);
    ...
    var m = new i(),
      s = {
        ...
        watch: {
          group: function(t, i) {
            t !== i && (m.$off('slideGroup:'.concat(i), this._groupSlideHandler), this.addGroupListeners());
          },
        ...
        methods: {
          slideTo: function(t, i) {
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.$emit('beforeSlide', { currentSlide: this.currentSlide, slideTo: h }),
                this.group && r && m.$emit('slideGroup:'.concat(this.group), t),
                (this.currentSlide = h),
                (this.isSliding = !0),
                window.setTimeout(function() {
                  (e.isSliding = !1), (e.currentSlide = d(h, e.slidesCount));
                }, s),
          ...
          initEvents: function() {
            null === this.defaults.rtl && (this.defaults.rtl = 'rtl' === getComputedStyle(this.$el).direction),
              ...
              this.config.wheelControl &&
                ((this.lastScrollTime = u()), this.$el.addEventListener('wheel', this.onWheel, { passive: !1 })),
              window.addEventListener('resize', this.update);
          },
          getCurrentSlideTimeout: function() {
            var t = d(this.currentSlide, this.slidesCount);
            return g(this)[t].componentOptions.propsData.duration;
          },
          ...
          onDragEnd: function() {
            ...
            if (((this.isDragging = !1), this.config.vertical)) {
              ...
              this.slideTo(this.currentSlide - f(this.delta.y) * i);
            }
            if (!this.config.vertical) {
              var e = (this.config.rtl ? -1 : 1) * f(this.delta.x),
          ...
          onWheel: function(t) {
            var i = this;
            if ((t.preventDefault(), !(u() - this.lastScrollTime < 200))) {
              this.lastScrollTime = u();
              var e = function() {
                  -1 === a && i.slideNext(), 1 === a && i.slidePrev();
                },
                r = t.deltaY,
                n = !(r && !Number.isInteger(r)),
                o = t.wheelDelta || -t.deltaY,
                s = Math.abs(o),
                a = f(o);
              n ? (s > this.prevDelta && e(), (this.prevDelta = s)) : e();
            }
          },
          addGroupListeners: function() {
            ...
            this.group &&
              ...
              m.$on('slideGroup:'.concat(this.group), this._groupSlideHandler));
          }
        },
        created: function() {
          this.initDefaults();
        ...
        beforeDestroy: function() {
          window.removeEventListener('resize', this.update),
            this.group && m.$off('slideGroup:'.concat(this.group), this._groupSlideHandler),
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = g(this), e = i.length, r = 0, n = [], o = 0; o < e; o++) {
                    var s = i[o],
      ...
      S = {
        ...
        computed: {
          currentSlide: function() {
            return d(this.$hooper.currentSlide, this.$hooper.slidesCount);
          },
          progress: function() {
    ...
    function $(t, i, e, r, n, o) {
      ...
      return t(
        'button',
        {
          class: ((s = {}), l(s, 'hooper-'.concat(r ? 'prev' : 'next'), !0), l(s, 'is-disabled', i), s),
          attrs: { type: 'button' },
          on: { click: o }
        },
        u
